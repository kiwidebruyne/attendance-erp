...
Company-event records are read-only seeded inputs in the mock world, and this policy only describes how they are read for leave conflict warnings.
...
- Keep company-event inputs read-only seeded and reference-only; the policy may read them, but leave endpoints do not mutate them.
...
| Moment                                                                                              | Policy Inputs                                                                                         | Policy Result                                                                                  | Required Surface Behavior                                                                                                                                                                                             |
| --------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Admin opens a leave request on a company-event date                                                 | A read-only seeded company-event record exists for the date                                           | company-event warning                                                                          | The review workspace shows the event context before the admin decides, and the warning is not hidden behind hover-only disclosure                                                                                     |
...
- How rich future company-event metadata should become beyond the current read-only seeded inputs
