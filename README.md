...
### 1. Codex는 문서와 지시 사항을 엄격하게 준수하려 하고, Claude Code는 눈치껏 알아서 잘 행동하려고 합니다.
...
### 2. Plan Mode는 거의 항상 켜 두는 것이 100배 낫습니다.
...
### 3. AI는 처음부터 다시 해오라고 해도 화내지 않습니다.
...
### 6. 리뷰는 같은 agent한테 시켜서는 안됩니다. 반드시 다른 agent나 완전히 다른 세션에게 시켜야 합니다.
...
### 8. 기록이 없으면 ai에게 맥락 제공 자체가 불가능합니다.
