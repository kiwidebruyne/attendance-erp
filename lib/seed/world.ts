...
const baselineWorkingCheckIns = deepFreeze([
  {
    employeeId: "emp_001",
    date: "2026-04-03",
    clockInAt: buildFixedSeoulDateTime("2026-04-03", "08:58:00"),
  },
  {
    employeeId: "emp_002",
    date: "2026-04-03",
    clockInAt: buildFixedSeoulDateTime("2026-04-03", "08:59:00"),
  },
  {
    employeeId: "emp_003",
    date: "2026-04-03",
    clockInAt: buildFixedSeoulDateTime("2026-04-03", "08:57:00"),
  },
  {
    employeeId: "emp_004",
    date: "2026-04-03",
    clockInAt: buildFixedSeoulDateTime("2026-04-03", "09:14:00"),
  },
  {
    employeeId: "emp_006",
    date: "2026-04-03",
...
const attendanceAttempts = deepFreeze(
  attendanceAttemptEntitySchema.array().parse([
    ...
    {
      id: attendanceAttemptId("emp_001", "2026-04-03", "clock_in", "success"),
      employeeId: "emp_001",
      date: "2026-04-03",
      action: "clock_in",
      attemptedAt: buildFixedSeoulDateTime("2026-04-03", "09:02:00"),
      status: "success",
      failureReason: null,
    },
    ...
    {
      id: attendanceAttemptId("emp_010", "2026-04-03", "clock_in", "failed"),
      employeeId: "emp_010",
      date: "2026-04-03",
      action: "clock_in",
      attemptedAt: buildFixedSeoulDateTime("2026-04-03", "09:08:00"),
      status: "failed",
...
const attendanceRecords = deepFreeze(
  attendanceRecordEntitySchema.array().parse([
    ...
    {
      id: attendanceRecordId("emp_001", "2026-04-03"),
      employeeId: "emp_001",
      date: "2026-04-03",
      clockInAt: buildFixedSeoulDateTime("2026-04-03", "09:02:00"),
      clockInSource: "beacon",
      clockOutAt: null,
      clockOutSource: null,
      workMinutes: null,
...
const manualAttendanceRequests = deepFreeze(
  manualAttendanceRequestEntitySchema.array().parse([
    ...
    },
    {
      ...
      action: "clock_in",
      date: "2026-04-17",
      submittedAt: buildFixedSeoulDateTime("2026-04-03", "11:18:00"),
    ...
    },
    {
      ...
      action: "both",
      date: "2026-04-20",
      submittedAt: buildFixedSeoulDateTime("2026-04-03", "11:42:00"),
    ...
    {
      id: manualRequestId("emp_010", "2026-04-03", "root"),
      employeeId: "emp_010",
      requestType: "manual_attendance",
      action: "clock_in",
      date: "2026-04-03",
      submittedAt: buildFixedSeoulDateTime("2026-04-03", "09:12:00"),
      requestedClockInAt: buildFixedSeoulDateTime("2026-04-03", "09:08:00"),
      requestedClockOutAt: null,
      reason: "Beacon connectivity failed during baseline check-in.",
      status: "rejected",
      reviewedAt: buildFixedSeoulDateTime("2026-04-03", "10:05:00"),
      reviewComment: "Please submit a follow-up if the beacon issue continues.",
      rootRequestId: manualRequestId("emp_010", "2026-04-03", "root"),
      parentRequestId: null,
      followUpKind: null,
      supersededByRequestId: null,
    },
    {
      id: manualRequestId("emp_010", "2026-04-03", "resubmission"),
      employeeId: "emp_010",
      requestType: "manual_attendance",
      action: "clock_in",
      date: "2026-04-03",
      submittedAt: buildFixedSeoulDateTime("2026-04-03", "10:28:00"),
      requestedClockInAt: buildFixedSeoulDateTime("2026-04-03", "09:08:00"),
      requestedClockOutAt: null,
      reason:
      ...
      reviewComment: null,
      rootRequestId: manualRequestId("emp_010", "2026-04-03", "root"),
      parentRequestId: manualRequestId("emp_010", "2026-04-03", "root"),
...
const leaveRequests = deepFreeze(
  leaveRequestEntitySchema.array().parse([
    ...
    {
      id: leaveRequestId("emp_005", "2026-04-03", "root"),
      employeeId: "emp_005",
      requestType: "leave",
      leaveType: "annual",
      date: "2026-04-03",
      startAt: null,
      endAt: null,
      reason: "Approved full-day leave for the baseline Friday shift.",
      requestedAt: buildFixedSeoulDateTime("2026-04-02", "14:10:00"),
      status: "approved",
      reviewedAt: buildFixedSeoulDateTime("2026-04-02", "17:20:00"),
      reviewComment: null,
      rootRequestId: leaveRequestId("emp_005", "2026-04-03", "root"),
      parentRequestId: null,
      followUpKind: null,
      supersededByRequestId: null,
    },
    {
      ...
      requestedAt: buildFixedSeoulDateTime("2026-04-03", "10:05:00"),
      status: "revision_requested",
      reviewedAt: buildFixedSeoulDateTime("2026-04-03", "16:10:00"),
    ...
    },
    {
      ...
      requestedAt: buildFixedSeoulDateTime("2026-04-03", "13:40:00"),
      status: "approved",
    ...
    },
    {
      ...
      requestedAt: buildFixedSeoulDateTime("2026-04-03", "09:30:00"),
      status: "approved",
    ...
    },
    {
      ...
      requestedAt: buildFixedSeoulDateTime("2026-04-03", "10:40:00"),
      status: "pending",
      reviewedAt: null,
      reviewComment: null,
    ...
    },
    {
      ...
      requestedAt: buildFixedSeoulDateTime("2026-04-03", "11:10:00"),
      status: "approved",
...
const requestReviewEvents = deepFreeze(
  requestReviewEventEntitySchema.array().parse([
    ...
    {
      id: "request_review_manual_emp_010_2026-04-03",
      requestId: manualRequestId("emp_010", "2026-04-03", "root"),
      decision: "reject",
      reviewComment: "Please submit a follow-up if the beacon issue continues.",
      reviewedAt: buildFixedSeoulDateTime("2026-04-03", "10:05:00"),
      reviewerId: "emp_012",
...
export const seedScenarioAnchors = deepFreeze({
  ...
  manualAttendanceResubmissionChain: {
    employeeId: "emp_010",
    rootRequestId: manualRequestId("emp_010", "2026-04-03", "root"),
    activeRequestId: manualRequestId("emp_010", "2026-04-03", "resubmission"),
  },
  pendingManualEdit: {
    employeeId: "emp_010",
